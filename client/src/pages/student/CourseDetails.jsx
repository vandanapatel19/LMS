  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='absolute top-0 left-0 w-full h-(--bg-section-height) -z-1 bg-linear-to-b from-cyan-100/70'></div>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='pt-4 md:texr-base text-sm' dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }} ></p>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Vertex</span></p>
        ...
        {/* right */}
        <div className='max-w-(--maxWidth-course-card) z-10 shadow-(--boxShadow-course-card) rounded-t md:rounded-none overflow-hidden bg-white min-w-75 sm:min-w-105 '>
          {
            playerData ?
          ...
          <div className='p-5'>
            ...
            <div className='pt-6'>
              <p className='font-medium md:text-xl text-lg text-gray-800'>What's in the course</p>
              <ul className=' ml-4 list-disc pl-4 pt-2 text-gray-500 text-sm md:text-default'>
