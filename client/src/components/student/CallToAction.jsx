...
const CallToAction = () => {
  return (
    <div className=' pb-24 pt-10 md:px-0 flex flex-col items-center gap-4'>
      <h1 className='text-xl md:text-4xl text-gray-800 font-semibold' >Learn anything, anytime, anywhere</h1>
      <p className='text-gray-500 sm:text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, iusto.
      </p>
